...
const pillars = [
  { icon: Music, title: "Multiple Genres", desc: "Amapiano, Afrobeats, Hip Hop, House, and everything in between." },
  { icon: Users, title: "Top DJs", desc: "Featuring Mauritius' finest selectors and rising talents." },
  { icon: Zap, title: "Non-Stop Energy", desc: "6+ hours of continuous music and unstoppable vibes." },
    ...
    <section id="about" className="py-28 bg-black relative" data-testid="about-section">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="flex items-center gap-4 mb-16">
          ...
          <span className="text-[#c72d28] text-xs uppercase tracking-[0.3em] font-medium">About</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20 items-start">
          ...
          <div className="pt-2 lg:pt-6">
            <p className="text-white/60 text-lg leading-relaxed mb-6" data-testid="about-description">
              After Dark Socials is a movement. Born from the underground rave culture of Mauritius,
            ...
            <p className="text-white/40 text-base leading-relaxed mb-10" data-testid="about-description-2">
            ...
            <button
              ...
              className="group flex items-center gap-4 text-white/40 hover:text-white transition-colors text-xs uppercase tracking-[0.2em]"
        ...
        {/* Stats */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-white/10 mb-20">
          {stats.map((stat) => (
            <div key={stat.label} className="bg-black p-8 sm:p-10 text-center">
              <div
              ...
              <div className="text-[10px] text-white/30 uppercase tracking-[0.25em]">{stat.label}</div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-white/10">
          {pillars.map((item) => (
            ...
            >
              <item.icon className="w-5 h-5 text-[#c72d28] mb-6" strokeWidth={1.5} />
